...
// }
//TODO: replace usages with: import.meta.env.VITE_APP_ID defined in  .env file
// const getAppParamValue = (paramName, { defaultValue = undefined, removeFromUrl = false } = {}) => {
// 	if (isNode) {
// 		return defaultValue;
// 	}
// 	const storageKey = `wiecare_${toSnakeCase(paramName)}`;
...
// 		storage.removeItem('wiecare_access_token'); //TODO: replace with localStorage.removeItem('token');
